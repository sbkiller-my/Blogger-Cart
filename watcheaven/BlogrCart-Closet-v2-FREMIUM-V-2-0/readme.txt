------------------------------------------------------------
BlogrCart ClosetV2 Freemium - A Responsive E-commerce Theme for Blogger
----------------------------------------------------------------
Theme Version:		Version 2.0 	
Created Date: 		December-2015   
Last Modified: 		December-2015
Demo URL:		http://blogrcart-closet-v2.blogspot.com
...
COMPLIMENTARY COPY
Strictly for 1 install & 1 license usage only.
...
- upload/pages upload/BlogrCart-*-PAGES-UPLOAD.V-*-*xml
- upload/template/BlogrCart-*-TEMPLATE-UPLOAD-V-*-*.xml
- documentation/
- icons/
...
UNZIP BLOGGER TEMPLATE FILE BlogrCart-*-V-*.zip 

1. 	Blogger dashboard > Template > Back Up/Restore > Choose "Upload a template from 
   	a file on your hard drive" > select file named BlogrCart-*-TEMPLATE-UPLOAD-V-*-*.xml and begin upload.
...
2. 	Go to Settings > Others > Blog Tools section > click the "Import Blog"
	...
	Select the file named BlogrCart-*-PAGES-UPLOAD-V-*-*.xml from your computer and upload
   	to your blog.
